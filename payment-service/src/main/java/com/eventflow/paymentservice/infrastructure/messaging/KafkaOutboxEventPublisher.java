...
public class KafkaOutboxEventPublisher implements OutboxEventPublisherPort {
    ...
    private Object toEvent(OutboxEvent outboxEvent) throws Exception {
        ...
        return switch (eventType) {
            case PAYMENT_COMPLETED -> objectMapper.readValue(outboxEvent.payload(), PaymentCompletedEvent.class);
            case PAYMENT_FAILED -> objectMapper.readValue(outboxEvent.payload(), PaymentFailedEvent.class);
